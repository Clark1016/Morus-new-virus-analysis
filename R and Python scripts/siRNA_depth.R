...
library(svglite)
# 用于拼接图形
setwd("E:/Project/project_Morus_virus/depth_total/siRNA_depth")
# 定义输入文件路径和 RNA 名称
input_files <- c("TRINITY_DN7047_c0_g2_i1_siRNA.depth.list", 
                 "TRINITY_DN8130_c0_g1_i1_siRNA.depth.list", 
                 "TRINITY_DN55899_c0_g1_i1_siRNA.depth.list")  # 替换为实际文件名
...
# 保存最终合并图
ggsave("siRNA_depth.svg", plot_combined, width = 12, height = 12)
