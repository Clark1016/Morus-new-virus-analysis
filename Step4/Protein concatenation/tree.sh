...
mafft --auto virus_combine.fa > virus_combine.mafft.fasta
trimal -in virus_combine.mafft.fasta -out virus_combine.mafft.trimal.fasta -automated1
iqtree -s virus_combine.mafft.trimal.fasta -T auto -m MFP -b 1000 -redo
